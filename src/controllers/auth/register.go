...
func RegisterController(data models.Register) (bool, string) {
	...
	_, err = db.MongoClient.Database(db.DatabaseName).Collection("admin_alerts").InsertOne(context.Background(), bson.M{
		"type":       "new_user",
		"title":      "New user registered",
		"message":    fmt.Sprintf("A new account was created for %s.", data.Email),
