...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.AdminForgotPasswordRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.AdminLoginRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/reset-password": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Admin reset details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.AdminResetPasswordRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/support/conversations": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Customer email or user ID",
                        "name": "customer",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Date filter in RFC3339 format",
                        "name": "date",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.SupportConversationListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SupportConversationUpdateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SupportMessageRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.BalanceSummary"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.CreateCryptoPaymentRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.SubmitCryptoPaymentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/investigate": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Investigation request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.InvestigateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.NotificationUpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.PaystackInitializeRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/routes.PaystackVerifyRequest"
                        }
                    },
                    {
                        "type": "string",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.AdvanceScanRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.BasicScanRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/scan/message": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Message content to scan",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.MessageScanRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.MidScanRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.URLScanRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.WalletScanRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/scan/{scanType}/pdf": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Content to scan for the selected scanType",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.ScanRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateSupportConversationRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.WalletSummary"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.ConnectSolanaWalletRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.ResendOTPRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.CreateSupportConversationRequest": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
                    "example": "My payment was completed but my tokens were not added."
                },
                "subject": {
                    "type": "string",
        ...
        "models.NotificationUpdateRequest": {
            ...
            "properties": {
                "message": {
                    "type": "string",
                    "example": "Your advanced scan finished with a suspicious verdict."
                },
                "title": {
                    "type": "string",
        ...
        "models.ReceiptRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Pro subscription payment"
                },
                "payer_email": {
                    "type": "string",
                    "example": "user@example.com"
        ...
        "models.SupportConversationListResponse": {
            "type": "object",
            "properties": {
                "conversations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.SupportConversation"
                    }
                },
                "limit": {
                    "type": "integer"
        ...
        "models.SupportConversationUpdateRequest": {
            "type": "object",
            "properties": {
                "assignedTo": {
                    "type": "string",
                    "example": "64d8e0d1a29b3d4a9f3401aa"
                },
                "status": {
                    "type": "string",
                    "example": "pending"
        ...
        "models.SupportMessageRequest": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
                    "example": "I have attached the payment reference."
                }
            }
        },
        ...
        "routes.AdminForgotPasswordRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string",
                    "example": "ganium.team@gmail.com"
                }
            }
        },
        ...
        "routes.AdminResetPasswordRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string",
        ...
        "routes.AdvanceScanRequest": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string",
                    "example": "Claim your reward at https://secure-login-example.com/verify before it expires."
                }
            }
        },
        "routes.BasicScanRequest": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string",
                    "example": "Your account will be suspended unless you confirm your password now."
                }
            }
        },
        "routes.ConnectSolanaWalletRequest": {
            "type": "object",
            "properties": {
                "network": {
                    "type": "string"
        ...
        "routes.CreateCryptoPaymentRequest": {
            "type": "object",
            "properties": {
                "plan": {
                    "type": "string",
        ...
        "routes.MessageScanRequest": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string",
                    "example": "Please send the 0.5 ETH to this address right away so we can release the funds."
                }
            }
        },
        "routes.MidScanRequest": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string",
                    "example": "We detected unusual activity. Please update your payment details immediately."
                }
            }
        },
        "routes.PaystackInitializeRequest": {
            "type": "object",
            "properties": {
                "callback": {
                    "type": "string",
                    "example": "https://app.ganium.ai/payment/callback"
                },
                "callbackUrl": {
                    "type": "string",
                    "example": "https://app.ganium.ai/payment/callback"
                ...
                "reference": {
                    "type": "string",
                    "example": "GANIUM-123456"
                }
            }
        },
        "routes.PaystackVerifyRequest": {
            "type": "object",
            "properties": {
                "reference": {
                    "type": "string",
        ...
        "routes.ScanRequest": {
            ...
            "properties": {
                "content": {
                    "type": "string",
                    "example": "Congratulations! You have won a prize. Click this link now."
                }
            }
        },
        "routes.SubmitCryptoPaymentRequest": {
            "type": "object",
            "properties": {
                "payment_id": {
                    "type": "string",
                    "example": "GAN-SJLY-123456789"
                },
                "signature": {
                    "type": "string",
                    "example": "5abc123..."
        ...
        "routes.URLScanRequest": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string",
                    "example": "https://secure-login-example.com/account/verify?session=123"
                }
            }
        },
        ...
        "routes.WalletScanRequest": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string",
                    "example": "0x3fD2b5e4c7A9E2d6C1b8F0a3D4e5F67890123456"
                }
            }
        }
    },
